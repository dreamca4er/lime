...
select 'MoneyReceive' as Cmd
    , OperationDate 
    , concat(
          '{"OperationDate":"'  , convert(nvarchar(27),pm.OperationDate, 126)
        , '","CommandType":"'   , 'Prd.Domain.Commands.MoneyReceivedCommand, Prd.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null'
        , '","CommandSnapshot":', pm.CommandSnapshot 
        , ',"ProductId":'       , pm.ProductId
        , ',"OperationFullName":"', 'Prd.Domain.Operations.ShortTermOperations.ShortTermCreditReceiveMoneyOperation'
        , '"}'  
        )  as FullJson
from (
...
select
    'Prolong'
    , cast(sp.BuiltOn as date) as OperationDate
    , concat(
          '{"OperationDate":"'  , format(sp.BuiltOn, 'yyyy-MM-ddT00:00:00')
        , '","CommandType":"'   , 'Prd.Domain.Commands.ProlongCommand, Prd.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null'
        , '","CommandSnapshot":', sp.CommandSnapshot 
        , ',"ProductId":'       , sp.ProductId
        , ',"OperationFullName":"', 'Prd.Domain.Operations.ShortTermOperations.Prolong.ShortTermCreditProlong201810Operation'
        , '"}'  
        )  as FullJson
from (
    select sp.BuiltOn 
